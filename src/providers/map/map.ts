...
export class MapProvider {
  ...
  getRouteAtm(latStart,lngStart,latEnd,lngEnd){
    console.log(latStart,lngStart,latEnd,lngEnd)

    let url= `http://open.mapquestapi.com/directions/v2/route?key=dzzGLtalbTyS2VtmOZoLDGpCfGa3whIu&from=${latStart},${lngStart}&to=${latEnd},${lngEnd}`
    console.log(url)
